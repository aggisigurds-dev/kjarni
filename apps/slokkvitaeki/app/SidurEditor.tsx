              ...
              return (
                <div className="blk" key={i}>
                  <div className="blk-top">
                    <b>{def?.label || b.gerd}</b>
                    <div className="blk-btns">
                      <button type="button" onClick={() => moveBlock(i, -1)} aria-label="Upp">↑</button>
                      <button type="button" onClick={() => moveBlock(i, 1)} aria-label="Niður">↓</button>
