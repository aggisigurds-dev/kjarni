        ...
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-3 px-4 py-4">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm text-stone-500">
              {isHome
                ? 'Drag a window by its title bar, resize from any edge or corner. Create a whiteboard to paste images. On a phone: three columns, tap ▾ to collapse. Hold a link to move it. Hide URLs, names, or images for the whole site.'
